...
uses
  ...
  //
  UTipoNotaFiscal, UCondicoesPagamento, UOrcamentoPedidoVenda, UVenda, UFreteVenda,
  UVendaRomaneioEntrega;
...
begin
  NovaAba(TFCondicoesPagamento, 44);
end;

procedure TFMenu.SpkLargeButton2Click(Sender: TObject);
begin
  NovaAba(TFOrcamentoPedidoVenda, 42);
end;
