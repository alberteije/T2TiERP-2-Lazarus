...
uses
  ...
  URegistroCartorio, UContabilParametros, UContabilIndice, UContabilHistorico,
...
type
  ...
  TFMenu = class(TForm)
    ...
    procedure SpkSmallButton11Click(Sender: TObject);
    procedure SpkSmallButton12Click(Sender: TObject);
    procedure SpkSmallButton13Click(Sender: TObject);
    procedure SpkSmallButton14Click(Sender: TObject);
    ...
    procedure SpkSmallButton7Click(Sender: TObject);
    procedure SpkSmallButton8Click(Sender: TObject);
    procedure SpkSmallButton9Click(Sender: TObject);
...
procedure TFMenu.SpkSmallButton7Click(Sender: TObject);
begin
  Application.CreateForm(TFContabilBalancoPatrimonial, FContabilBalancoPatrimonial);
  FContabilBalancoPatrimonial.ShowModal;
end;

procedure TFMenu.SpkSmallButton8Click(Sender: TObject);
begin
  NovaAba(TFContabilEncerramentoExercicio, 46);
end;
...
begin
  NovaAba(TFContabilLivro, 50);
end;

procedure TFMenu.SpkLargeButton9Click(Sender: TObject);
begin
  NovaAba(TFContabilConta, 53);
end;

procedure TFMenu.SpkSmallButton10Click(Sender: TObject);
begin
  NovaAba(TFContabilParametros, 52);
end;

procedure TFMenu.SpkSmallButton11Click(Sender: TObject);
begin
  NovaAba(TFContabilIndice, 49);
end;

procedure TFMenu.SpkSmallButton12Click(Sender: TObject);
begin
  NovaAba(TFContabilHistorico, 48);
end;

procedure TFMenu.SpkSmallButton13Click(Sender: TObject);
begin
  NovaAba(TFAidfAimdf, 45);
end;

procedure TFMenu.SpkSmallButton14Click(Sender: TObject);
begin
  NovaAba(TFFap, 54);
end;
...
begin
  NovaAba(TFContabilLancamentoOrcado, 57);
end;

procedure TFMenu.SpkSmallButton2Click(Sender: TObject);
begin
  NovaAba(TFContabilLancamento, 58);
end;

procedure TFMenu.SpkSmallButton3Click(Sender: TObject);
begin
  NovaAba(TFContabilFechamento, 47);
end;

procedure TFMenu.SpkSmallButton4Click(Sender: TObject);
begin
  NovaAba(TFContabilLancamentoPadrao, 55);
end;

procedure TFMenu.SpkSmallButton5Click(Sender: TObject);
begin
  NovaAba(TFContabilLote, 56);
end;

procedure TFMenu.SpkSmallButton9Click(Sender: TObject);
begin
  NovaAba(TFRegistroCartorio, 62);
end;
