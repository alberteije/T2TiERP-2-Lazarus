...
uses
  ...
  URegistroCartorio, UFiscalParametros, UTipoNotaFiscal, UTabelasSimplesNacional,
  UFiscalLivro, UEntradaNF, UFiscalApuracao, UFiscalInformativosGuias;
