...
uses
  ...
  UConciliacaoBancaria, UConciliacaoCliente, UConciliacaoFornecedor,
...
begin
  NovaAba(TFConciliacaoCliente, 56);
end;

procedure TFMenu.SpkLargeButton2Click(Sender: TObject);
begin
  NovaAba(TFConciliacaoFornecedor, 58);
end;

procedure TFMenu.SpkLargeButton3Click(Sender: TObject);
begin
  NovaAba(TFConciliaContabilLancamento, 57);
end;
...
begin
  NovaAba(TFConciliacaoBancaria, 55);
end;

procedure TFMenu.SpkLargeButton6Click(Sender: TObject);
begin
  NovaAba(TFComposicaoSaldo, 54);
end;
{$EndRegion}
