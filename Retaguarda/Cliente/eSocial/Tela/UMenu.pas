...
uses
  ...
  UCompraTipoRequisicao, UCompraTipoPedido, UCompraRequisicao, UCompraCotacao,
  UCompraConfirmaCotacao, UCompraMapaComparativo, UCompraPedido, UCriterioCompraSugerida;
...
begin
  NovaAba(TFCompraTipoRequisicao, 50);
end;
