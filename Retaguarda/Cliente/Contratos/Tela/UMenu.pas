...
uses
  ...
  UContratoTipoServico, UTipoContrato, UContratoSolicitacaoServico,
  UContratoTemplate, UContrato;
...
begin
  NovaAba(TFContratoTipoServico, 58);
end;

procedure TFMenu.SpkLargeButton6Click(Sender: TObject);
begin
  NovaAba(TFContrato, 54);
end;
{$EndRegion}
