...
uses
  Classes, SysUtils, FileUtil, pickdate, SpkToolbar, spkt_Tab, spkt_Pane, spkt_Buttons,
  Forms, Controls, Graphics, Dialogs, ComCtrls, Menus, ACBrPonto,
  //
  UPontoParametro, UPontoHorario, UPontoEscala, UPontoClassificacaoJornada,
  UPontoAbono, UPontoRelogio, UPontoBancoHoras, UPontoTratamentoArquivoAFD,
  UPontoGeracaoArquivos, UPontoEspelho;
...
begin
  ...
  begin
    ...
    vACBrPonto := TACBrPonto.Create(Self);
  end;
end;
