...
// *********************************************************************//
  IPrivateKeyDisp = dispinterface
    ...
    procedure Open(const pContainerName: WideString; const pProviderName: WideString; 
                   pProviderType: CAPICOM_PROV_TYPE; pKeySpec: CAPICOM_KEY_SPEC;
...
procedure TPrivateKey.Open(const pContainerName: WideString; const pProviderName: WideString; 
                           pProviderType: CAPICOM_PROV_TYPE; pKeySpec: CAPICOM_KEY_SPEC; 
                           StoreLocation: CAPICOM_STORE_LOCATION; bCheckExistence: WordBool);
begin
