...
uses
  ...
  UPlanoNaturezaFinanceira, UPlanoCentroResultado, UNaturezaFinanceira,
  UCentroResultado, UFinTipoRecebimento, UFinTipoPagamento, UFinStatusParcela,
  UFinDocumentoOrigem, UFinConfiguracaoBoleto;
