...
uses
  ...
  UFinParcelaPagamento, UFinResumoTesouraria, UFinChequeRecebido;
...
begin
  NovaAba(TFFinResumoTesouraria, 153);
end;

procedure TFMenu.SpkLargeButton2Click(Sender: TObject);
begin
  NovaAba(TFFinChequeRecebido, 93);
end;
...
begin
  NovaAba(TFFinParcelaPagamento, 142);
end;
