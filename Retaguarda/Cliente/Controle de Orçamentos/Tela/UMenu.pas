...
uses
  ...
  Forms, Controls, Graphics, Dialogs, ComCtrls, Menus, StdCtrls,
  //
  UOrcamentoEmpresarial, UOrcamentoPeriodo, UOrcamentoFluxoCaixaPeriodo,
...
begin
  NovaAba(TFOrcamentoFluxoCaixaPeriodo, 50);
end;

procedure TFMenu.SpkLargeButton2Click(Sender: TObject);
begin
  NovaAba(TFOrcamentoFinanceiroCaixa, 42);
end;

procedure TFMenu.SpkLargeButton3Click(Sender: TObject);
begin
  NovaAba(TFOrcamentoEmpresarial, 46);
end;
