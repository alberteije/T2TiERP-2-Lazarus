...
<div class="bloco">
                    <div class="titulo_bloco">
                        <h1>T2Ti ERP 2.0 - Lazarus</h1>
                    </div>
  Aqui é possível baixar o código fonte do Projeto T2Ti ERP 2.0 em Lazarus. 
  ...
  ERP no mercado. Mais informações sobre o treinamento podem ser encontradas no seguinte link: http://t2ti.com/erp2/. 
  	<br /><br />
  <i>
  [Here it is possible to download the source code of the Project T2Ti ERP 2.0 in Lazarus. This training was made by thousands of developers in Brazil and helped hundreds of them launch their own ERP in the market. More information about the training can be found at the following link: http://t2ti.com/erp2/.]
  </i>
                    <hr />
