...
uses UCaixa, UIdentificaCliente, ClienteVO, EcfFuncionarioVO, UImportaNumero,
  Controller, UImportaProduto, EcfFuncionarioController;

{$R *.lfm}

procedure TFLocaliza.FormClose(Sender: TObject; var CloseAction: TCloseAction);
begin
  CloseAction := caFree;
  FLocaliza:= nil;
end;
